		...
		function (e, t, i) {
			...
			var y = (function (e) {
				function t(e) {
					...
					return (
						(i.options = { data: [], title: "", selectedIndex: null, showCls: "show" }),
						(0, u.extend)(i.options, e),
						(i.data = i.options.data),
						(i.pickerEl = (0, f.createDom)(
							(0, m.default)({ data: i.data, title: i.options.title })
						)),
					...
					a(t, [
						...
						},
						{
							...
							value: function (e, t) {
								var i = this;
								return (
									(this.wheels[t] = new h.default(e[t], {
										wheel: !0,
						...
						},
						{
							...
							value: function (e) {
								...
								window.setTimeout(function () {
									if (
										((0, f.addClass)(t.maskEl, i),
										(0, f.addClass)(t.panelEl, i),
										t.wheels)
									)
						...
						},
						{
							...
							value: function (e, t) {
								...
								if (i && n) {
									...
									return (
										(this.selectedIndex[e] = s), n.refresh(), n.wheelTo(s), s
									);
								}
							},
						},
				...
				return (function (e) {
						...
						t.BScroll = (function (e) {
							function t(e, i) {
								...
								return (
									...
									(o.translateZ =
										o.options.HWCompositing && a.hasPerspective
											? " translateZ(0)"
											: ""),
									(o.options.useTransition =
										o.options.useTransition && a.hasTransition),
									(o.options.useTransform =
										o.options.useTransform && a.hasTransform),
									(o.options.eventPassthrough =
										o.options.eventPassthrough === !0
											? "vertical"
											: o.options.eventPassthrough),
									(o.options.preventDefault =
										!o.options.eventPassthrough && o.options.preventDefault),
									(o.options.scrollX =
										"horizontal" !== o.options.eventPassthrough &&
										o.options.scrollX),
									(o.options.scrollY =
										"vertical" !== o.options.eventPassthrough &&
										o.options.scrollY),
									(o.options.freeScroll =
										o.options.freeScroll && !o.options.eventPassthrough),
									(o.options.directionLockThreshold = o.options.eventPassthrough
										? 0
										: o.options.directionLockThreshold),
									o.options.tap === !0 && (o.options.tap = "tap"),
									o._init(),
									o.options.snap && o._initSnap(),
									o.refresh(),
									o.options.snap ||
										o.scrollTo(o.options.startX, o.options.startY),
									o.enable(),
									o
								);
							}
							return (
								...
								s(t, [
											...
											"string" == typeof this.options.snap &&
												...
												this.on("refresh", function () {
													if (
														...
														e.goToPage(
															e.currentPage.pageX || d,
															e.currentPage.pageY || 0,
															0
														),
															e.options.snapThreshold % 1 === 0
																? ((e.snapThresholdX =
																		e.options.snapThreshold),
																  (e.snapThresholdY =
																		e.options.snapThreshold))
																: ((e.snapThresholdX = Math.round(
																		e.pages[
																			e.currentPage.pageX
																		][e.currentPage.pageY]
																			.width *
												...
												this.on("scrollEnd", function () {
													e.options.snapLoop &&
														...
														e.currentPage.pageX ===
															e.pages.length - 1 &&
															e.goToPage(1, e.currentPage.pageY, 0));
												}),
												this.on("flick", function () {
													var t =
														...
														Math.max(
															Math.max(
																Math.min(
																	Math.abs(e.x - e.startX),
																	1e3
																),
																Math.min(
																	Math.abs(e.y - e.startY),
																	1e3
																)
															),
															300
													...
													e.goToPage(
														e.currentPage.pageX + e.directionX,
														e.currentPage.pageY + e.directionY,
														t
													);
												});
										},
									...
									},
									{
										key: "_handleEvents",
										value: function (e) {
											var t = this.options.bindToWrapper
												? this.wrapper
												: window;
											e(window, "orientationchange", this),
												e(window, "resize", this),
												this.options.click &&
													e(this.wrapper, "click", this),
									...
									},
									{
										...
										value: function (e) {
											if (
												this.enabled &&
												a.eventType[e.type] === this.initiated
											) {
												...
												if (
													...
													if (
														(this.directionLocked ||
															...
															(r >
															o + this.options.directionLockThreshold
													...
													var l = this.x + i,
														h = this.y + n;
													(l > 0 || l < this.maxScrollX) &&
														(l = this.options.bounce
															? this.x + i / 3
															: l > 0
															? 0
															: this.maxScrollX),
														(h > 0 || h < this.maxScrollY) &&
										...
										value: function (e) {
											if (
												...
												if (!this.moved) {
													if (this.options.wheel) {
														if (
															...
															var n = Math.abs(
																	Math.round(i / this.itemHeight)
																),
																r = Math.round(
																	(this.pointY +
																		(0, a.offset)(this.target)
																			.top -
																		this.itemHeight / 2) /
																		this.itemHeight
																);
												...
												if (
													...
													l < this.options.momentumLimitDistance
												)
									...
									},
									{
										...
										value: function () {
											var e = this,
												t =
													arguments.length <= 0 || void 0 === arguments[0]
														...
														: arguments[0];
											if (
												((this.scrollerStyle[a.style.transitionDuration] =
													t + "ms"),
											...
											!t &&
												...
												((this.scrollerStyle[a.style.transitionDuration] =
													"0.001s"),
												(0, a.requestAnimationFrame)(function () {
													"0.0001ms" ===
														e.scrollerStyle[
															a.style.transitionDuration
														] &&
											...
											if (
												...
												for (var i = 0; i < this.items.length; i++) {
													var n =
														this.options.rotate *
														(t / this.itemHeight + i);
													this.items[i].style[a.style.transform] =
														"rotateX(" + n + "deg)";
												}
											(this.x = e), (this.y = t);
										},
											...
											var e =
												...
												t =
													arguments.length <= 1 || void 0 === arguments[1]
														...
														: arguments[1],
												i = this.x;
											!this.hasHorizontalScroll || i > 0
												? (i = 0)
												: i < this.maxScrollX && (i = this.maxScrollX);
											var n = this.y;
											return (
												!this.hasVerticalScroll || n > 0
													? (n = 0)
													: n < this.maxScrollY && (n = this.maxScrollY),
												(i !== this.x || n !== this.y) &&
													(this.scrollTo(i, n, e, t), !0)
											);
										},
									},
									{
										...
										value: function (e, t, i, n, r) {
											if (
												...
												(o.left -= this.wrapperOffset.left),
													...
													this.options.wheel &&
														(o.top =
															Math.round(o.top / this.itemHeight) *
															this.itemHeight),
													(t =
					...
					function (e, t) {
						...
						function i(e) {
							return (
								f !== !1 &&
								("standard" === f ? e : f + e.charAt(0).toUpperCase() + e.substr(1))
							);
						}
						function n(e, t, i, n) {
						...
						var u = document.createElement("div").style,
							...
							d = i("transform"),
							m =
								((t.hasPerspective = i("perspective") in u),
								...
								o(e, [
									...
									},
									{
										...
										value: function (e) {
											...
											if (t)
												for (
													var n = t.length, o = [].concat(i(t)), s = 0;
													s < n;
													s++
												) {
													var a = o[s],
					...
					function (e, t) {
						...
						function i(e, t, i, n, r, o) {
							var s = e - t,
								...
								d = e + (a / l) * (s < 0 ? -1 : 1);
							return (
								o.wheel && h && (d = Math.round(d / h) * h),
								d < n
									? ((d = r ? n - (r / f) * a : n), (u = c - p))
									: d > 0 && ((d = r ? (r / f) * a : 0), (u = c - p)),
								{ destination: Math.round(d), duration: u }
							);
						}
			...
			e.exports = (n.default || n).template(function (e, t, i, n, r) {
				...
				function s(e, t) {
					...
					return (
						...
						(r = i.value)
							? (n = r.call(e, { hash: {}, data: t }))
							: ((r = e && e.value),
							  (n = typeof r === c ? r.call(e, { hash: {}, data: t }) : r)),
						(o += p(n) + '">'),
						(r = i.text)
							? (n = r.call(e, { hash: {}, data: t }))
							: ((r = e && e.text),
				...
				return (
					...
					(l = i.title)
						? (a = l.call(t, { hash: {}, data: r }))
						: ((l = t && t.title),
						  (a = typeof l === c ? l.call(t, { hash: {}, data: r }) : l)),
					(h +=
						p(a) +
					...
					e.registerHelper("each", function (e, t) {
						...
						if (
							...
							if (p(e))
								...
								for (var l in e)
									e.hasOwnProperty(l) &&
										(i && ((i.key = l), (i.index = o), (i.first = 0 === o)),
										(s += n(e[l], { data: i })),
										o++);
				...
				var i = function (e, i, n, r, o, s) {
					...
					n = {
						...
						merge: function (e, t) {
							var i = e || t;
							return (
								e && t && e !== t && ((i = {}), h.extend(i, t), h.extend(i, e)), i
							);
						},
				...
				function o(e, t) {
					...
					return (
						...
						(r = i.value)
							? (n = r.call(e, { hash: {}, data: t }))
							: ((r = e && e.value),
							  (n = typeof r === a ? r.call(e, { hash: {}, data: t }) : r)),
						(o += l(n) + '">'),
						(r = i.text)
							? (n = r.call(e, { hash: {}, data: t }))
							: ((r = e && e.text),
