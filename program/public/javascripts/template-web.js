	...
	return (function (e) {
			...
			var r = n(6),
				...
				a = function u(e) {
					...
					"string" != typeof e ? (t = e) : (t.source = e),
						...
						t.filename &&
							(t.filename = t.resolveFilename(t.filename, t));
					var n = t.filename,
						a = t.cache,
						c = t.caches;
					if (a && n) {
			...
			var s = (function () {
				...
				E = (function () {
					function e(t) {
						...
						(this.source = x),
							this.getTplTokens(x, t.rules, this).forEach(
								function (e) {
		...
		function (e, t, n) {
			...
			function r(e) {
				...
				return (
					(t.line = e.line), (t.start = e.start), (t.end = e.end), t
				);
			}
			function i(e, t, n) {
				(this.type = e),
